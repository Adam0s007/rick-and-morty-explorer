...
describe("ProfileCard", () => {
  it("renders correctly for an alive character", () => {
    ...
    expect(
      screen.getByRole("img", { name: aliveCharacter.name }),
    ).toHaveAttribute("src", aliveCharacter.image);
  ...
  it("renders correctly for a dead character", () => {
    ...
    expect(
      screen.getByRole("img", { name: deadCharacter.name }),
    ).toHaveAttribute("src", deadCharacter.image);
  ...
  it("renders correctly for an unknown status character", () => {
    ...
    expect(
      screen.getByRole("img", { name: unknownCharacter.name }),
    ).toHaveAttribute("src", unknownCharacter.image);
